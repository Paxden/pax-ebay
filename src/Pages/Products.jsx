...
function Products() {
  return (
    <div className="products">
      <div className="buttons d-flex mb-3 align-items-center gap-5">
        <div className="btn btn-md btn-outline-secondary text-bg-success">Products</div>
        <div className="btn btn-md btn-outline-danger">Alerts</div>
        <div className="btn btn-md btn-outline-warning">Unsold</div>
      </div>
      <div className="bult-action d-flex align-items-center gap-3">
        <Form.Check />
